...
export default function Home() {
  ...
  const filteredProducts = products.filter((p) => {
    ...
    const matchWish =
      !showOnlyWishlist || (isWishlisted && isWishlisted(p.id));
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ fontSize: "30px", fontWeight: "900", margin: "0 0 6px" }}>
          KNB CLOTHING
        </h1>
        <p style={{ color: "#666", fontSize: "14px", margin: 0 }}>
          Everyday clothes, simply. Direct WhatsApp ordering & quick delivery.
        </p>
      </div>

...
export default function CheckoutPage() {
  ...
  const handleWhatsAppCheckout = (e) => {
    ...
    if (!name.trim() || !phone.trim() || !address.trim() || !pincode.trim()) {
      alert("Please fill in Name, Phone, Address, and Pincode.");
      return;
    }
    ...
    msg += `• *Address:* ${address.trim()}, ${city.trim()} - ${pincode.trim()}\n`;
    if (orderNotes.trim()) {
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "40px" }}>
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div>
              <label style={{ display: "block", fontSize: "13px", fontWeight: 600, marginBottom: "4px" }}>Street Address *</label>
              <textarea
                rows={2}
